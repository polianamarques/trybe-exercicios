...
function List({ messages, setMessageStatus }) {
    // Reparou que estamos recebendo a função setMessageStatus como prop? Essa é a função que altera o status de um e-mail. Ela deve receber como parâmetro o id do e-mail que será alterado e qual o novo status dele. Essa função deverá ser criada no arquivo App.js:
    return (
